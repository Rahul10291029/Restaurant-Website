      ...
      <section className="py-16 px-6 md:px-20 bg-white">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold">
            {t('about_why_choose_us_title')}
          </h2>
          <p className="mt-2 text-gray-600">
            {t('about_why_choose_us_subtitle')}
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            { titleKey: "about_value_authentic_title", descKey: "about_value_authentic_desc", icon: "🍛" },
            { titleKey: "about_value_ambience_title", descKey: "about_value_ambience_desc", icon: "🪔" },
            { titleKey: "about_value_service_title", descKey: "about_value_service_desc", icon: "👨‍🍳" },
          ].map((item, idx) => (
            <motion.div
              key={idx}
